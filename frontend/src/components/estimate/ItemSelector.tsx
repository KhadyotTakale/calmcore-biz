...
import { Search, Package, Loader2, Plus, RefreshCw } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { getItems, Item, searchItems, cacheManager } from "@/services/api";
    ...
    <div className="relative">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center justify-center rounded-lg border border-border bg-background px-3 py-2 text-foreground transition-all hover:bg-muted hover:border-primary/30 disabled:opacity-50 disabled:cursor-not-allowed"
